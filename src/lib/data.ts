...
export const projects: Project[] = [
  ...
  {
    route: "/project-3",
    title: "Devnnova — Software Agency Website",
    titleMain: "Devnnova",
    ...
    intro:
      "A human-centred agency website that makes Devnnova’s strategy, design and engineering services clear, guides visitors to its work, and turns interest into project conversations.",
    paragraphs: [
