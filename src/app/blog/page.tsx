      ...
      <div className="mil-banner-content mil-up">
        ...
        <div className="container">
          ...
          <h1 className="mil-mb-60">
            Exploring
            <span className="mil-thin">the World</span>
            <br />
            Through Our
            <span className="mil-thin">Blog</span>
          </h1>
          ...
          <div className="col-lg-8 mil-mb-30">
            <div className="mil-adaptive-right mil-up">
              <ul className="mil-category-list">
                ...
                <li>
                  <Link href="/blog-inner">Technology</Link>
                </li>
                <li>
                  <Link href="/blog-inner" className="mil-active">All categories</Link>
                </li>
              </ul>
            </div>
          </div>
