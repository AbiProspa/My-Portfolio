    ...
    <section className="mil-p-120-0">
      <div className="container mil-p-0-120" id="project">
        <div className="mil-image-frame mil-horizontal mil-up">
          ...
          <a data-fancybox="gallery" data-no-swup="" href="/img/works/1/1.jpg" className="mil-zoom-btn">
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="mil-image-frame mil-square mil-up mil-mb-30">
                ...
                <a data-fancybox="gallery" data-no-swup="" href="/img/works/1/2.jpg" className="mil-zoom-btn">
                  <img src="/img/icons/zoom.svg" alt="zoom" />
                </a>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="mil-image-frame mil-square mil-up mil-mb-30">
                ...
                <a data-fancybox="gallery" data-no-swup="" href="/img/works/1/3.jpg" className="mil-zoom-btn">
                  <img src="/img/icons/zoom.svg" alt="zoom" />
                </a>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="mil-image-frame mil-square mil-up mil-mb-30">
                ...
                <a data-fancybox="gallery" data-no-swup="" href="/img/works/1/4.jpg" className="mil-zoom-btn">
                  <img src="/img/icons/zoom.svg" alt="zoom" />
                </a>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="mil-image-frame mil-square mil-up mil-mb-30">
                ...
                <a data-fancybox="gallery" data-no-swup="" href="/img/works/1/5.jpg" className="mil-zoom-btn">
                  <img src="/img/icons/zoom.svg" alt="zoom" />
                </a>
              </div>
            </div>
          ...
          <div className="row mil-p-0-90">
            <div className="col-lg-6">
              <div className="mil-image-frame mil-vertical mil-up mil-mb-30">
                ...
                <a data-fancybox="gallery" data-no-swup="" href="/img/works/1/6.jpg" className="mil-zoom-btn">
                  <img src="/img/icons/zoom.svg" alt="zoom" />
                </a>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="mil-image-frame mil-vertical mil-up mil-mb-30">
                ...
                <a data-fancybox="gallery" data-no-swup="" href="/img/works/1/7.jpg" className="mil-zoom-btn">
                  <img src="/img/icons/zoom.svg" alt="zoom" />
                </a>
              </div>
            </div>
        ...
        <div className="mil-works-nav mil-up">
          ...
          <Link href="/project-2" className="mil-link mil-dark mil-arrow-place">
