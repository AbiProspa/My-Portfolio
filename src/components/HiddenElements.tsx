/**
 * Invisible source elements the runtime clones into placeholders on every
 * page: the arrow icon (-> .mil-arrow-place), the dodecahedron
 * (-> .mil-animation) and the decorative lines (-> .mil-lines-place).
 */
