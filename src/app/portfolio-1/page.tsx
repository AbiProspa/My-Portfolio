      ...
      <div className="container mil-portfolio mil-p-120-60">
        ...
        <div className="row justify-content-between align-items-center">
          <div className="col-lg-5">
            <Link href="/project-1" className="mil-portfolio-item mil-more mil-mb-60">
          ...
          <div className="col-lg-6">
            <Link href="/project-2" className="mil-portfolio-item mil-more mil-parallax mil-mb-60" data-value-1="60" data-value-2="-60">
          ...
          <div className="col-lg-6">
            <Link href="/project-3" className="mil-portfolio-item mil-more mil-parallax mil-mb-60" data-value-1="60" data-value-2="-60">
              <div className="mil-cover-frame mil-hori mil-up">
                <div className="mil-cover">
          ...
          <div className="col-lg-5">
            <Link href="/project-4" className="mil-portfolio-item mil-more mil-mb-60">
              <div className="mil-cover-frame mil-vert mil-up">
                <div className="mil-cover">
          ...
          <div className="col-lg-6">
            <Link href="/project-6" className="mil-portfolio-item mil-more mil-parallax mil-mb-60" data-value-1="60" data-value-2="-60">
              <div className="mil-cover-frame mil-hori mil-up">
                <div className="mil-cover">
