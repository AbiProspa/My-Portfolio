  ...
  return (
    ...
    <section className="mil-p-120-0">
      <div className="mil-image-frame mil-fw mil-up">
        ...
        <a data-fancybox="gallery" data-no-swup="" href="/img/works/5/1.jpg" className="mil-zoom-btn">
      ...
      <div className="container mil-p-0-120" id="project">
            ...
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <div className="mil-image-frame mil-square mil-drag">
                  ...
                  <a data-fancybox="gallery" data-no-swup="" href="/img/works/5/2.jpg" className="mil-zoom-btn">
                    <img src="/img/icons/zoom.svg" alt="zoom" />
                  </a>
                </div>
              </div>
              <div className="swiper-slide">
                <div className="mil-image-frame mil-square mil-drag">
                  ...
                  <a data-fancybox="gallery" data-no-swup="" href="/img/works/5/3.gif" className="mil-zoom-btn">
                    <img src="/img/icons/zoom.svg" alt="zoom" />
                  </a>
                </div>
              </div>
              <div className="swiper-slide">
                <div className="mil-image-frame mil-square mil-drag">
                  ...
                  <a data-fancybox="gallery" data-no-swup="" href="/img/works/5/4.jpg" className="mil-zoom-btn">
                    <img src="/img/icons/zoom.svg" alt="zoom" />
                  </a>
                </div>
              </div>
              <div className="swiper-slide">
                <div className="mil-image-frame mil-square mil-drag">
                  ...
                  <a data-fancybox="gallery" data-no-swup="" href="/img/works/5/5.gif" className="mil-zoom-btn">
                    <img src="/img/icons/zoom.svg" alt="zoom" />
                  </a>
                </div>
              </div>
              <div className="swiper-slide">
                <div className="mil-image-frame mil-square mil-drag">
                  ...
                  <a data-fancybox="gallery" data-no-swup="" href="/img/works/5/6.jpg" className="mil-zoom-btn">
                    <img src="/img/icons/zoom.svg" alt="zoom" />
                  </a>
                </div>
              </div>
        ...
        <div className="mil-image-frame mil-horizontal mil-up mil-mb-120">
          ...
          <a data-fancybox="gallery" data-no-swup="" href="/img/works/5/7.gif" className="mil-zoom-btn">
            <img src="/img/icons/zoom.svg" alt="zoom" />
          </a>
        </div>
        <div className="mil-works-nav mil-up">
          <Link href="/project-4" className="mil-link mil-dark mil-arrow-place mil-icon-left">
            <span>Prev project</span>
          </Link>
          <Link href="/portfolio-1" className="mil-link mil-dark">
            <span>All projects</span>
          </Link>
          <Link href="/project-6" className="mil-link mil-dark mil-arrow-place">
