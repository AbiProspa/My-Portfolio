/* Converted from the Ashley HTML template — markup preserved, copy is mine.
   Shared by the /404 route and Next's not-found boundary. It lives in a
   component rather than being re-exported from the page module, because
   re-exporting one page from another breaks Next's build-trace collection. */
